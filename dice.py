...
#     player1_sides= player1_dice
#     player2_sides= player2_dice

#     for item in player1_sides:
#         if item % 6 == 0:
#             player1_sides.remove(item)
#             return player1_sides

#     for item in player2_sides:
#         if item % 6 == 0:
#             player2_sides.remove(item)
#             return player2_sides
...
while player1_score < 3 or player2_score < 3:
    ...
    time.sleep(2)
    print("You have rolled: ",player1_dice_results)
    ...
    time.sleep(2)
    print("Player 2 has rolled:" ,player2_dice_results)
